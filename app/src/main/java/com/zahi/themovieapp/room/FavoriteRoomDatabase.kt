package com.zahi.themovieapp.room

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.zahi.themovieapp.dao.ActorDao
import com.zahi.themovieapp.dao.MovieDao
...
@Database(entities = arrayOf(MovieInfo::class, ActorInfo::class), version = 1, exportSchema = false)
